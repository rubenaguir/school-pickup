...
const LOGIN_MESSAGES: Record<string, string> = {
  ...
  ACCOUNT_SUSPENDED: 'Esta cuenta está suspendida. Contacta a tu institución.',
  EMAIL_NOT_VERIFIED: 'Verifica el correo antes de entrar. Se envió un enlace al registrarlo.',
