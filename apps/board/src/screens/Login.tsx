...
/**
 * A kiosk still needs a human to sign in once at install time (ADR-068
 * point 1) — a dedicated per-institution account is the recommended
 * practice, but this screen has no way to enforce that, it is a normal
 * login.
 */
